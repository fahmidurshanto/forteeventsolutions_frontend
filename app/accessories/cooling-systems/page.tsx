...
const GALLERY_IMAGES = [
  "/Accessories/accessories_17.webp",
  "/Accessories/accessories_18.webp",
  "/Accessories/accessories_19.webp",
  "/Accessories/accessories_20.webp",
];

export default function CoolingSystemsPage() {
  return (
    <main className="min-h-screen bg-[#0F172A]">
      <RentalHero title="Fans & Cooling Systems" image="/Accessories/accessories_17.webp" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 text-sm font-bold italic">
          ...
          <span className="text-[#B48E4B]">Cooling Systems</span>
        </div>
      </div>
      ...
      <section className="py-16 bg-[#131B2E] border-b border-white/5 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-300 text-lg leading-relaxed italic font-medium opacity-90">
            Keep your guests cool, comfortable, and refreshed with our high-capacity Fans and Cooling Systems.
            Designed specifically for Singapore's tropical climate, our range includes industrial evaporative air coolers,
            heavy-duty pedestal prop fans, and high-performance commercial portable air-conditioning units suitable
            for tents, exhibition halls, and outdoor events.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {GALLERY_IMAGES.map((img, i) => (
              ...
              >
                <Image src={img} alt={`Cooling System ${i + 1}`} fill sizes="(max-width: 768px) 100vw, 25vw" className="object-cover transition-transform duration-700 group-hover:scale-110" />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter leading-tight">
              Why Choose Our <span className="text-[#B48E4B]">Cooling Systems</span>?
            </h2>
            <ul className="space-y-5">
              {[
                "High-performance industrial-grade air flow and rapid cooling",
                "Whisper-quiet operational technology suitable for speeches and VIP functions",
                "Fully portable units with heavy-duty castors for fast repositioning",
                "Perfect for large dome tents, outdoor wedding halls, and sports events",
                "Professional setup, electrical wiring management, and dismantling included",
                "Eco-friendly cooling options with highly efficient energy consumption",
              ].map((f, i) => (
          ...
          <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white/5">
            <Image src="/Accessories/accessories_17.webp" alt="Cooling system showcase" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
