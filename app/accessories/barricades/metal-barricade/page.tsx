...
const GALLERY_IMAGES = [
  "/metal-barricades/Gemini_Generated_Image_2z60dd2z60dd2z60.png",
  "/barricade_1.webp",
  "/metal-barricades/image-removebg-preview.png",
];

export default function MetalBarricadePage() {
  return (
    <main className="min-h-screen bg-[#0F172A]">
      <RentalHero title="Metal Barricade" image="/metal-barricades/Gemini_Generated_Image_2z60dd2z60dd2z60.png" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 text-sm font-bold italic">
          ...
          <span className="text-gray-600">/</span>
          <span className="text-[#B48E4B]">Metal Barricade</span>
        </div>
      </div>
      ...
      <section className="py-16 bg-[#131B2E] border-b border-white/5 px-4">
        <div className="max-w-3xl mx-auto text-center space-y-6">
          <p className="text-gray-300 text-lg leading-relaxed italic font-medium opacity-90">
            Our high-strength Metal Barricades are designed to handle heavy crowd pressure and provide 
            secure boundaries for large-scale events. Made from galvanized steel, these barriers are 
            weather-resistant and feature an interlocking system to create an unbreakable line of defense.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter leading-tight">
              Unbreakable <span className="text-[#B48E4B]">Perimeter Control</span>
            </h2>
            <ul className="space-y-5">
              {[
                "Heavy-duty galvanized steel for maximum durability",
                "Integrated interlocking hooks for secure connections",
                "Stable flat-feet or bridge-feet options for various terrains",
                "Lightweight enough for manual deployment by two people",
                "Rust-proof finish for long-term outdoor event use",
                "Ideal for festivals, concerts, parades, and sports events",
              ].map((feature, i) => (
          ...
          <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white/5">
            <Image
              src="/barricade_1.webp"
              alt="Metal Barricade setup"
              fill
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
            {GALLERY_IMAGES.map((img, i) => (
              ...
              >
                <Image 
                  src={img} 
                  alt={`Metal Barricade Gallery ${i + 1}`} 
                  fill 
