...
export default function RoadClosurePage() {
  return (
    <main className="min-h-screen bg-[#0F172A]">
      <RentalHero title="Road Closure Equipment" image="/Road%20Closure/road_closure_1.webp" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 text-sm font-bold italic">
          ...
          <span className="text-[#B48E4B]">Road Closure</span>
        </div>
      </div>
      ...
      <section className="py-16 bg-[#131B2E] border-b border-white/5 px-4">
        <div className="max-w-3xl mx-auto text-center">
          <p className="text-gray-300 text-lg leading-relaxed italic font-medium opacity-90">
            Ensure public safety and professional crowd control at your event with our premium Road Closure barriers.
            Designed for durability, high visibility, and fast deployment, our systems are ideal for outdoor events,
            street festivals, sporting matches, and public gatherings across Singapore.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            {GALLERY_IMAGES.map((img, i) => (
              ...
              >
                <Image src={img} alt={`Road Closure ${i + 1}`} fill sizes="(max-width: 768px) 100vw, 25vw" className="object-cover transition-transform duration-700 group-hover:scale-110" />
      ...
      {/* Why Choose Our Road Closure Barriers */}
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter leading-tight">
              Why Choose Our <span className="text-[#B48E4B]">Road Barriers</span>?
            </h2>
            <ul className="space-y-5">
              {[
                "Highly visible reflective panels for maximum safety day and night",
                "Rugged construction built to withstand heavy wind and crowds",
                "Modular and interlocking design for custom setups and enclosures",
                "Easy and rapid setup, positioning, and breakdown by our team",
                "Perfect for outdoor carnivals, marathons, roadshows, and street markets",
                "Compliance with Singapore safety and crowd management guidelines",
              ].map((f, i) => (
          ...
          <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white/5">
            <Image src="/Road%20Closure/road_closure_2.webp" alt="Road Closure setup" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
