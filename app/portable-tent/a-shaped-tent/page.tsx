...
const AVAILABLE_WIDTHS = ["20ft", "24ft", "28ft", "32ft", "37ft", "40ft", "52ft"];

const GALLERY_IMAGES = [
  "/A-Shape%20Tent/a-shape_tent_1.webp",
  "/A-Shape%20Tent/a-shape_tent_2.webp",
];

export default function AShapedTentPage() {
  return (
    <main className="min-h-screen bg-[#0F172A]">
      <RentalHero title="A-Shaped Tent" image="/A-Shape%20Tent/a-shape_tent_1.webp" />
      ...
      <div className="max-w-7xl mx-auto px-4 py-6">
        <div className="flex items-center gap-2 text-sm font-bold italic">
          ...
          <span className="text-[#B48E4B]">A-Shaped Tent</span>
        </div>
      </div>
        ...
        <div className="max-w-4xl mx-auto space-y-12">
          <div className="text-center">
            <p className="text-gray-300 text-lg leading-relaxed italic font-medium opacity-90">
              The A-Shaped Tent is a classic peaked-roof structure that delivers excellent coverage and
              a timeless silhouette. Its robust frame can withstand demanding weather conditions, making
              it the go-to choice for large-scale events, exhibitions, weddings, and community gatherings
              across Singapore.
            </p>
          </div>
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
            {GALLERY_IMAGES.map((img, i) => (
              ...
              >
                <Image src={img} alt={`A-Shaped Tent gallery ${i + 1}`} fill sizes="(max-width: 768px) 100vw, 33vw" className="object-cover transition-transform duration-700 group-hover:scale-110" />
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-20 items-center">
          <div className="space-y-8">
            <h2 className="text-4xl md:text-5xl font-black text-white uppercase italic tracking-tighter leading-tight">
              Why Choose Our <span className="text-[#B48E4B]">A-Shaped Tent</span>?
            </h2>
            <ul className="space-y-5">
              {[
                "Classic peaked-roof design with a strong and reliable frame",
                "Available in 7 different widths from 20ft to 52ft",
                "Ideal for weddings, exhibitions, corporate dinners, and community events",
                "Robust structure capable of withstanding strong winds and heavy rain",
                "Pairs well with side walls, flooring, air-conditioning, and lighting",
                "Professional setup and dismantling by our experienced team",
              ].map((feature, i) => (
          ...
          <div className="relative aspect-[4/3] rounded-[3rem] overflow-hidden shadow-2xl group border-8 border-white/5">
            <Image src="/A-Shape%20Tent/a-shape_tent_2.webp" alt="A-Shaped Tent setup" fill sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover transition-transform duration-1000 group-hover:scale-110" />
